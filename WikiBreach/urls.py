...
urlpatterns = [
    ...
    url(r'^getAlerts/', view.get_google_alerts, name='getAlerts'),
    url(r'^posts/', include('posts.urls')),
    url(r'^search', search_views.search, name='search'),
    url(r'^pwnedCheck/', view.pwnedCheck, name='pwnedCheck'),
    url('^subscribe/', subscribe_views.subscribe, name='subscribe'),
    url('^contactUs/', subscribe_views.contact_us, name='contactUs'),
    url('^aboutUs/', subscribe_views.about_us, name='aboutUs'),
